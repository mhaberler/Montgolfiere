import { mqttBrokerUrl, mqttUser, mqttPassword } from '@/composables/useAppState';
import { computed, ref } from 'vue';

import mqtt from 'mqtt';

// Re-export for backward compatibility and direct usage
export { mqttBrokerUrl, mqttUser, mqttPassword };
